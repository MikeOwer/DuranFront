...
@Component({
  ...
  styleUrl: './ver-pagos.component.scss'
})
export class VerPagosComponent {
  ...
  ngOnInit() {
    ...
    this.router.params.subscribe(params => {
      ...
      this.verPagos(this.idCliente);
    });
  }

  verPagos(event: any){
    this.servicioGeneral.get('customer/pagos/'+event,{}, false).subscribe({
      next: (data) => {
