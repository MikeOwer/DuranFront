...
@Component({
  ...
  styleUrl: './ver-observaciones.component.scss'
})
export class VerObservacionesComponent {
  ...
  ngOnInit() {
    ...
    this.router.params.subscribe(params => {
      ...
      this.verObservaciones(this.idCliente);
    });
  }

  verObservaciones(event: any){
    this.servicioGeneral.get('customer/observaciones/'+event,{}, false).subscribe({
      next: (data) => {
