...
export class EditcreditComponent implements OnInit {
      ...
      this.servicioGeneral.get('customers', {}, false).subscribe((clientes: any) => {
        ...
        this.servicioGeneral.get('customer_guarantee', {}, false).subscribe((guarantees: any) => {
          ...
          this.form.patchValue({
            ...
            rent_price: this.data.cliente.rent_price,
            extra_name: this.data.cliente.extra_name,
            extra_phone_number: this.data.cliente.extra_phone_number,
            familiar_relationship: this.data.cliente.familiar_relationship,
            ...
            immediate_supervisor_name: this.data.cliente.immediate_supervisor_name,
  ...
  goToNextTab() {
    ...
    if (this.form.invalid && this.activeIndex === 0) {
      console.log("Formulario inválido. Errores por control:");
